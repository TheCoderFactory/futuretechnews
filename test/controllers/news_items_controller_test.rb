...
class NewsItemsControllerTest < ActionController::TestCase
  ...
  test "should create news_item" do
    assert_difference('NewsItem.count') do
      post :create, news_item: { description: @news_item.description, favicon: @news_item.favicon, main_image: @news_item.main_image, title: @news_item.title, url: @news_item.url }
    end
  ...
  test "should update news_item" do
    patch :update, id: @news_item, news_item: { description: @news_item.description, favicon: @news_item.favicon, main_image: @news_item.main_image, title: @news_item.title, url: @news_item.url }
    assert_redirected_to news_item_path(assigns(:news_item))
  end
